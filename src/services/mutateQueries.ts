...
const addItem = async (queryClient: QueryClient, queryKey: any[], item: any) => {
...
const updateItem = async (queryClient: QueryClient, queryKey: any[], item: any) => {
  await queryClient.cancelQueries(queryKey);
...
const deleteItem = async (queryClient: QueryClient, queryKey: any[], itemId: any) => {
  await queryClient.cancelQueries(queryKey);
